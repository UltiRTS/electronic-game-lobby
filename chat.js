...
function chatPut(Name, Desc="Intergalactic Quantum Com", isBattleChat=false) {   //call this function back on joining chat
	if (isBattleChat == false){
		...
		document.getElementById("chatList").innerHTML +="<p style=\"filter: drop-shadow(0.3rem 0.3rem 0.1rem rgba(33,150,243,0.7));\" id=\"chatTag"+Name+"\"><span onclick=\"chatSwt(&#39;"+Name+"&#39;,displayedChat)\"style=\"background-color: #2196f3;color: white; padding: 5px;\">"+Name.substring(0, 6)+"</span><span onclick=\"chatLeave(&#39;"+Name+"&#39;)\" id=\"chatClose\" class=\"chatClose\" style=\"\">＼</span></p>";
		}
		else {
			document.getElementById("chatList").innerHTML +="<p style=\"filter: drop-shadow(0.3rem 0.3rem 0.1rem rgba(33,150,243,0.7));\" id=\""+Name+"\"><span onclick=\"chatSwt(&#39;"+Name+"&#39;,displayedChat)\"style=\" background-color: #2196f3;color: white; padding: 5px;\">"+Name.substring(0, 6)+"</span><span  id=\"chatClose\" class=\"chatClose\" style=\"\">⊟</span></p>";
		}
