...
function minimizeToolTip(){
 if (document.getElementById('actualHelp').style.visibility==''){document.getElementById('actualHelp').style.visibility='hidden'}
 else {document.getElementById('actualHelp').style.visibility=''}
}
